...
if __name__ == "__main__":
    working_dir = "/storage/brno2/home/stepanb2/Czech-Metaphor-Detection/Data/CZECH_unannotated/"
    
    # read raw text file, split punctuation, return with all labels 0
    df_annotated = load_raw_text_annotate_zeroes(working_dir + "fiction-train.txt", "unannotated")
    ...
    df_all = add_pos_to_df(working_dir + "unannotated.conllu", df_annotated)
    
    # save as sentences
    with open(working_dir + "czech_unannotated_sentences.json", 'w', encoding='utf-8') as f:
        df_all.to_json(f)
